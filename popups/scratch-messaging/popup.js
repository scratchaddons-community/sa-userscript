  ...
  const vue = new Vue({
    ...
    computed: {
      feedbackUrl() {
        ...
        return `https://scratchaddons.com/feedback/?ext_version=${manifest.version_name}&utm_source=userscript&utm_medium=messagingcrash&utm_campaign=v${manifest.versions}`;
      },
      profilesOrdered() {
